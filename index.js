...
drive(distance) {
  ...
  // this.fuel = this.distance / this.milesPerGallon;
  if (this.tank <= 0) {
  return `I ran out of fuel at ${this.odometer} miles!`;}
  // else if (this.tank > this.fuel) {
  else if (this.tank > this.distance / this.milesPerGallon) {
    this.tank -= this.distance / this.milesPerGallon;
    this.odometer += this.distance;
  }
  else if (this.tank < this.distance / this.milesPerGallon && this.tank > 0) {
